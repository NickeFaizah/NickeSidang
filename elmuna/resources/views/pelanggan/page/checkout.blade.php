...
@section('content')
<div class="breadcrumb-section checkout breadcrumb-bg">
    <div class="container">
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body pembayaran">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <input type="number" class="form-control dibayarkan" id="dibayarkan" name="jumlahBarang" value="{{ $jumlahbarang }}" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="dibayarkan" class="col-form-label col-sm-6">Total Quantity</label>
                        <div class="col-sm-6">
                            <input type="number" class="form-control dibayarkan" id="dibayarkan" name="totalQty" value="{{ $qtyOrder }}" readonly>
                        </div>
                    </div>
