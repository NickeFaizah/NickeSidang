...
<head>
    ...
    <style>
        body {
            background: url(/assets/img/ban.png) no-repeat center center fixed;
            ...
            <form action="{{ route('loginProses') }}" method="POST">
                ...
                <div class="card-body">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <input type="email" class="p-2 form-control-plaintext" id="email" name="email" value="" autocomplete="off" autofocus>
                        </div>
                    </div>
                    <div class="mb-3 row">
