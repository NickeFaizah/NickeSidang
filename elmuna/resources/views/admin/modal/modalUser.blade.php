            ...
            <form action="{{ route('addDataUser') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="nama" autocomplete="off">
                            @error('name')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <img class="mb-2 preview" style="width: 100px; height: 100px; border-radius: 50%;">
