                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="type" name="type">
                                ...
                                <option value="MunchipsChocolate" {{ $data->type === 'MunchipsChocolate' ? 'selected' : '' }}>Munchips Chocolate</option>
                                <option value="Munchips CaramelSesame" {{ $data->type === 'MunchipsCaramelSesame' ? 'selected' : '' }}>Munchips Caramel Sesame</option>
                                <option value="Munchips Original" {{ $data->type === 'MunchipsOriginal' ? 'selected' : '' }}>Munchips Original</option>
                                <option value="Munchips PeanutCaramel" {{ $data->type === 'MunchipsPeanutCaramel' ? 'selected' : '' }}>Munchips Peanut Caramels</option>
                                <option value="Munchips Spicy" {{ $data->type === 'MunchipsSpicy' ? 'selected' : '' }}>Munchips Spicy Flavor</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="kategori" name="kategori">
                                ...
                                <option value="munchips100g" {{ $data->kategory === 'munchips100g' ? 'selected' : '' }}>munchips100g</option>
                                <option value="munchips200g" {{ $data->kategory === 'munchips200g' ? 'selected' : '' }}>munchips200g</option>
                                <option value="munchips250g" {{ $data->kategory === 'munchips250g' ? 'selected' : '' }}>munchips250g</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
