            ...
            <form action="{{ route('updateDataUSer', $data->id ) }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="nama" autocomplete="off" value="{{$data->name}}">
                            @error('name')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <input type="password" class="form-control" id="password" name="password" autocomplete="off" value="{{password_needs_rehash($data->password,'PASSWORD_BCRYPT')}}">
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            ...
                            <img class="mb-2 preview" style="width: 100px; height: 100px; border-radius: 50%;" src="{{asset('storage/user/'.$data->foto)}}">
