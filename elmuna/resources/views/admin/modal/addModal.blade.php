        ...
        <div class="modal-content modal-md">
            ...
            <form action="{{ route('addData') }}" enctype="multipart/form-data" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 row">
                        <label for="kategori" class="col-sm-5 col-form-label">Type Product</label>
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="type" name="type">
                                <option value=""> Pilih Type </option>
                                <option value="MunchipsChocolate">Munchips Chocolate</option>
                                <option value="MunchipsCaramel Sesame">Munchips Caramel Sesame</option>
                                <option value="MunchipsOriginal">Munchips Original</option>
                                <option value="MunchipsPeanutCaramel">Munchips Peanut Caramel</option>
                                <option value="MunchipsSpicy">Munchips Spicy Flavor</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <select type="text" class="form-control" id="kategori" name="kategori">
                                ...
                                <option value="Munchips200g">Munchips 100g</option>
                                <option value="Munchips200g">Munchips 200g</option>
                                <option value="Munchips250g">Munchips 250g</option>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" id="productModalLabel" name="deskripsi">
                        </div>
                    </div>
                    <div class="mb-3 row">
