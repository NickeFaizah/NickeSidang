<aside class="sidebar navbar navbar-expand-lg bg-dark d-flex flex-column gap-3 align-content-lg-center mx-2 my-2 rounded">
    <h5 class="navbar-brand">Elmuna Chips</h5>
